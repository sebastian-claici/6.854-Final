...
While for general graphs the problem has been effectively solved decades ago, for the special case where the graph is planar has seen a number of surprising developments in recent years.
...
The Kuratowski subgraphs are shown in figure~\ref{fig:kuratowski}.\\
